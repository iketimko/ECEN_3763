...
`timescale 1 ps / 1 ps
module PD_LAB_9_mm_interconnect_1 (
	...
	wire  [25:0] dma_0_read_master_translator_avalon_universal_master_0_address;       // dma_0_read_master_translator:uav_address -> dma_0_read_master_agent:av_address
	...
	wire  [95:0] rsp_mux_src_data;                                                     // rsp_mux:src_data -> dma_0_read_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                    // dma_0_read_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                                  // rsp_mux:src_channel -> dma_0_read_master_agent:rp_channel
	...
	wire  [95:0] dma_0_read_master_agent_cp_data;                                      // dma_0_read_master_agent:cp_data -> router:sink_data
	...
	PD_LAB_9_mm_interconnect_1_router router (
	...
	PD_LAB_9_mm_interconnect_1_router_001 router_001 (
	...
	PD_LAB_9_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_0_outclk1_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (pll_0_outclk1_clk),                                             //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),                       // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
