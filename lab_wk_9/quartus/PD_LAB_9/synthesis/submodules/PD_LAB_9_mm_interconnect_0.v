...
`timescale 1 ps / 1 ps
module PD_LAB_9_mm_interconnect_0 (
	...
	wire  [103:0] rsp_mux_001_src_data;                                                 // rsp_mux_001:src_data -> dma_0_read_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                // dma_0_read_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                              // rsp_mux_001:src_channel -> dma_0_read_master_agent:rp_channel
	...
	wire  [103:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> dma_0_control_port_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                    // dma_0_control_port_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                  // cmd_mux:src_channel -> dma_0_control_port_slave_agent:cp_channel
	...
	wire  [103:0] dma_0_read_master_agent_cp_data;                                      // dma_0_read_master_agent:cp_data -> router_001:sink_data
	...
	wire  [103:0] dma_0_control_port_slave_agent_rp_data;                               // dma_0_control_port_slave_agent:rp_data -> router_002:sink_data
	...
	wire    [2:0] router_004_src_channel;                                               // router_004:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire    [2:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;              // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire    [2:0] cmd_mux_002_src_channel;                                              // cmd_mux_002:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	PD_LAB_9_mm_interconnect_0_router router (
	...
	PD_LAB_9_mm_interconnect_0_router_001 router_001 (
	...
	PD_LAB_9_mm_interconnect_0_router_002 router_002 (
	...
	PD_LAB_9_mm_interconnect_0_router_002 router_003 (
	...
	PD_LAB_9_mm_interconnect_0_router_004 router_004 (
	...
	PD_LAB_9_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_0_outclk1_clk),                             //        clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_0_outclk1_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (pll_0_outclk1_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk1_clk),                       //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (pll_0_outclk1_clk),                                             //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),                       // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_0_outclk1_clk),                       //       clk.clk
		.reset               (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_LAB_9_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	PD_LAB_9_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
